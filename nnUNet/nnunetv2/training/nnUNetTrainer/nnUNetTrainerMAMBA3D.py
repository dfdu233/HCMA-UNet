...
from nnunetv2.training.nnUNetTrainer.variants.network_architecture.HCMA_ori import HCMA_ori
...
class nnUNetTrainerMAMBA3D(nnUNetTrainer):
    ...
    @staticmethod
    def _split_network_output(network_output):
        if isinstance(network_output, (tuple, list)) and len(network_output) == 2:
    ...
    # x: B,C,D,H,W
        ...
        with (
            ...
            fea, output = self._split_network_output(network_output)
            # del data
    ...
    def build_network_architecture(
       ...
       #model = Baselinev5_DenseDown(in_channels=1,n_classes=2,predict_mode=False)
        ...
        #         out_channels=num_output_channels,  # 假设分割为2类
        #         feature_size=16,
        #         hidden_size=256,
        #         num_heads=8,
